    ...
    private var mainContent: some View {
        VStack(spacing: ResponsiveSizing.spacing(baseSpacing: 6)) {
                ...
                ForEach(lengthOptions, id: \.self) { option in
                    Button(action: {
                        ...
                        Text(lengthLabels[option] ?? "")
                            ...
                            .shadow(color: wordLength == option ? Color("SlateBlueGrey").opacity(0.15) : .clear, radius: ResponsiveSizing.spacing(baseSpacing: 4), x: 0, y: ResponsiveSizing.spacing(baseSpacing: 2))
                    }
                    .buttonStyle(PlainButtonStyle())
                }
            }
            ...
            if !chain.isEmpty {
                ...
                .frame(height: ResponsiveSizing.tileSize(for: 4) * 4.2)
